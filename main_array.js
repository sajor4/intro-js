...
//     console.log(removeEven(paperoga))
    ...
    // 1) mapping function che prende input un array di numeri e restituisce un array con tutti i numeri diminuiti di uno

    // 2) mapping function che prende input un array di numeri e restituisce un array con i il valore assoluto 
    // dei numeri (togliere il meno dai negativi)

    // 3) mapping function che prende input un array di numeri e restituisce un array di stringhe con scritto 'PARI' se il 
    // numero corrispondente è pari o 'DISPARI se il numero corrispondente è dispari
